...
public class ImageRenderer extends AtlassianWikiRenderer {
    ...
    public ImageRenderer(EventPublisher eventPublisher, ApplicationProperties applicationProperties,
	    VelocityRequestContextFactory velocityRequestContextFactory, FeatureManager manager) {
	super(eventPublisher, applicationProperties, velocityRequestContextFactory, manager);
